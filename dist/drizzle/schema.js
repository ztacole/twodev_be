...
exports.assessor = (0, mysql_core_1.mysqlTable)('assessor', Object.assign({ id: (0, mysql_core_1.int)('id').primaryKey().autoincrement(), user_id: (0, mysql_core_1.int)('user_id').notNull().unique().references(() => exports.user.id, { onUpdate: 'cascade', onDelete: 'cascade' }), scheme_id: (0, mysql_core_1.int)('scheme_id').notNull().references(() => exports.scheme.id, { onUpdate: 'cascade', onDelete: 'cascade' }), no_reg_met: (0, mysql_core_1.varchar)('no_reg_met', { length: 255 }).notNull(), address: (0, mysql_core_1.varchar)('address', { length: 255 }).notNull(), phone_no: (0, mysql_core_1.varchar)('phone_no', { length: 255 }).notNull(), birth_date: (0, mysql_core_1.date)('birth_date').notNull() }, timestamps));
exports.assessorDetail = (0, mysql_core_1.mysqlTable)('assessor_detail', Object.assign({ id: (0, mysql_core_1.int)('id').primaryKey().autoincrement(), assessor_id: (0, mysql_core_1.int)('assessor_id').notNull().unique().references(() => exports.assessor.id, { onUpdate: 'cascade', onDelete: 'cascade' }), tax_id_number: (0, mysql_core_1.varchar)('tax_id_number', { length: 255 }).notNull(), bank_book_cover: (0, mysql_core_1.varchar)('bank_book_cover', { length: 255 }).notNull(), certificate: (0, mysql_core_1.varchar)('certificate', { length: 255 }).notNull(), national_id: (0, mysql_core_1.varchar)('national_id', { length: 255 }).notNull() }, timestamps));
