...
exports.approvalRequest = (0, mysql_core_1.mysqlTable)('approval_request', Object.assign({ id: (0, mysql_core_1.int)('id').primaryKey().autoincrement(), requester_admin_id: (0, mysql_core_1.int)('requester_admin_id').notNull().references(() => exports.admin.id, { onUpdate: 'cascade', onDelete: 'cascade' }), approver_admin_id: (0, mysql_core_1.int)('approver_admin_id').notNull().references(() => exports.admin.id, { onUpdate: 'cascade', onDelete: 'cascade' }), target_table: (0, mysql_core_1.varchar)('target_table', { length: 255 }).notNull(), target_id: (0, mysql_core_1.int)('target_id').notNull(), target_name: (0, mysql_core_1.varchar)('target_name', { length: 255 }), action: (0, mysql_core_1.varchar)('action', { length: 50 }).notNull(), status: (0, mysql_core_1.varchar)('status', { length: 50 }).notNull().default('pending'), comment: (0, mysql_core_1.text)('comment'), approved_at: (0, mysql_core_1.datetime)('approved_at') }, timestamps));
// ========= Relations =========
