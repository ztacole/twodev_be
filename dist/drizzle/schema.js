...
exports.result = (0, mysql_core_1.mysqlTable)('result', Object.assign({ id: (0, mysql_core_1.int)('id').primaryKey().autoincrement(), assessment_id: (0, mysql_core_1.int)('assessment_id').notNull().references(() => exports.assessment.id, { onUpdate: 'cascade', onDelete: 'cascade' }), assessor_id: (0, mysql_core_1.int)('assessor_id').notNull().references(() => exports.assessor.id, { onUpdate: 'cascade', onDelete: 'cascade' }), assessee_id: (0, mysql_core_1.int)('assessee_id').notNull().references(() => exports.assessee.id, { onUpdate: 'cascade', onDelete: 'cascade' }), score: (0, mysql_core_1.int)('score').default(-1), is_competent: (0, mysql_core_1.boolean)('is_competent').notNull(), tuk: exports.tukEnum.notNull() }, timestamps));
...
exports.approvalRequestRelations = (0, drizzle_orm_1.relations)(exports.approvalRequest, ({ one }) => ({
    ...
    backupApprover: one(exports.admin, {
        fields: [exports.approvalRequest.backup_admin_id],
        references: [exports.admin.id]
    }),
    approvedBy: one(exports.admin, {
        fields: [exports.approvalRequest.approved_by],
        references: [exports.admin.id]
    })
}));
exports.adminRelations = (0, drizzle_orm_1.relations)(exports.admin, ({ one, many }) => ({
    ...
    backupApprovalRequests: many(exports.approvalRequest, { relationName: 'backupApprover' }),
    approvedRequests: many(exports.approvalRequest, { relationName: 'approvedBy' })
}));
