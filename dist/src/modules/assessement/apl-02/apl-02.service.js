...
class APL02Service {
    static getUnitsAPL02(result_id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const unitCompetencies = yield drizzle_1.db.select().from(schema_1.ucApl02).where((0, drizzle_orm_1.eq)(schema_1.ucApl02.assessment_id, existingResult.assessment_id));
            const elementsByUc = yield Promise.all(unitCompetencies.map((uc) => __awaiter(this, void 0, void 0, function* () {
                ...
                const results = yield drizzle_1.db.select().from(schema_1.resultApl02).where((0, drizzle_orm_1.eq)(schema_1.resultApl02.result_apl02_id, result_id));
            ...
            return Promise.all(elementsByUc.map((_a) => __awaiter(this, [_a], void 0, function* ({ uc, elements, results }) {
                ...
                for (const el of elements) {
                    const row = yield drizzle_1.db.query.resultApl02.findFirst({ where: (0, drizzle_orm_1.and)((0, drizzle_orm_1.eq)(schema_1.resultApl02.result_apl02_id, result_id), (0, drizzle_orm_1.eq)(schema_1.resultApl02.element_id, el.id)) });
                    if (row)
                        completedElements += 1;
                }
    ...
    static getUnitsResult(result_id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const units = yield drizzle_1.db.select().from(schema_1.ucApl02).where((0, drizzle_orm_1.eq)(schema_1.ucApl02.assessment_id, existingResult.assessment_id));
            return {
                id: header.id,
