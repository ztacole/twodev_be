...
class AssesseeService {
    static getAssessees() {
        return __awaiter(this, arguments, void 0, function* (page = 1, limit = 10) {
            ...
            const countRows = yield drizzle_1.db.select({ count: (yield Promise.resolve().then(() => __importStar(require('drizzle-orm')))).sql `COUNT(*)` }).from(schema_1.assessee);
