...
exports.approve = exports.getDetail = exports.getApproved = exports.getPending = void 0;
...
const getPending = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield verificationService.getPendingVerifications();
...
const getApproved = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield verificationService.getApprovedVerifications();
        res.status(200).json({ success: true, data });
    }
    catch (error) {
        res.status(500).json({ success: false, message: error.message });
